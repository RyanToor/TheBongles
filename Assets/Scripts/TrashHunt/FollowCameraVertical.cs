...
public class FollowCameraVertical : MonoBehaviour
{
    ...
    private void LoadChasmPlate(int plateIndex, int direction)
    {
        ...
        chasmPlates[plateIndex].GetComponent<SpriteRenderer>().sprite =
            direction <= 0 && positionIndex[plateIndex] >= loadedChasms.Count?
            GenerateChasmPlate() : loadedChasms[chasmPositionIndex[plateIndex]];
    }
